...
public class Splash2Activity extends AppCompatActivity {
   ...
   AppCompatImageView splash_image, chooing_language_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        splash_image = findViewById(R.id.splashscreen);





        Glide.with(Splash2Activity.this).load(R.drawable.logo).into(splash_image);
       // Glide.with(Splash2Activity.this).load(R.drawable.detect_location).into(chooing_language_image);
        //Glide.with(Splash2Activity.this).load(R.drawable.splash_background).into(splashscreen2);
...
//                    finish();
    ...
    private void internetStatusCheck() {
        Log.e("CHECK","A");
        ConnectivityManager connectivityManager = (ConnectivityManager) Splash2Activity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        ...
        Snackbar snackbar = Snackbar.make(rlBaseLayout, "Please Connect Internet Connection  ?", Snackbar.LENGTH_INDEFINITE)
                .setAction("RETRY", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Splash2Activity.this.internetStatusCheck();
                    }
                });
